...
WWW::PAUSE::Recent - get the list of the recent uploads to PAUSE
...
Returns a WWW::PAUSE::Recent object. Takes two mandatory and one optional
arguments:
...
B<Mandatory>. Module requires you to have an account on
 L<http://pause.perl.org>. The
...
Take zero or one argument which must be a hashref of
